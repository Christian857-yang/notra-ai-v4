...
type Provider = "openai" | "openai-5" | "gemini"; // GPT-4o, GPT-5.1, Gemini 3.0
        ...
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3 sm:px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <ModelToggleButton id="openai" label="GPT-4o" />
              <ModelToggleButton id="openai-5" label="GPT-5.1" />
              <ModelToggleButton id="gemini" label="Gemini 3.0" />
            </div>
